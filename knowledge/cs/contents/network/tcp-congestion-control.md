...
retrieval-anchor-keywords: tcp congestion control, cwnd, rwnd, slow start, aimd, rtt, retransmission, queue buildup, bandwidth delay product, sender rate, tcp congestion control basics, tcp congestion control beginner, tcp congestion control intro, network basics, beginner network
