...
retrieval-anchor-keywords: http 메서드 기초, rest api 기초, http method 뭐가 있나요, get post put delete 차이, 멱등성이 뭐예요, idempotent 뜻, safe method 뜻, rest 란, rest api 설계 입문, 리소스 기반 api, http method beginner
