...
- [싱글톤 (Singleton) 디자인 패턴이란](#싱글톤-singleton-디자인-패턴이란)
- [게으른 초기화](#게으른-초기화)
- [모듈 싱글톤](#모듈-싱글톤)
- [모노스테이트 싱글톤 패턴](#모노스테이트-싱글톤-패턴)
- [싱글톤과 메타클래스](#싱글톤과-메타클래스)
- [싱글톤 패턴 사용 사례 1](#싱글톤-패턴-사용-사례-1)
- [싱글톤 패턴 사용 사례 2](#싱글톤-패턴-사용-사례-2)
