...
[Inbound Adapter Test Slices Primer](./inbound-adapter-test-slices-primer.md)는 controller와 message handler를 slice test와 앱 통합 테스트로 어떻게 나눌지 설명한다.
...
즉 controller는 **많은 slice + 적은 앱 통합 테스트**가 기본형이다.
