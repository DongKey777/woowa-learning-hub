...
retrieval-anchor-keywords: dto vo entity 차이, dto 뭐예요, dto entity 처음 헷갈려요, entity를 응답으로 내보내도 되나요, dto vs entity, dto vs vo, request dto response dto, jpa entity vs domain entity, 도메인 객체 차이, dto 왜 쓰나요, beginner dto entity vo, request dto service command entity 흐름, record는 vo에 왜 맞나요, entity를 map key로 써도 되나요
