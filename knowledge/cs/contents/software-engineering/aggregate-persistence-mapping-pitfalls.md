...
retrieval-anchor-keywords: aggregate persistence mapping pitfalls basics, aggregate persistence mapping pitfalls beginner, aggregate persistence mapping pitfalls intro, software engineering basics, beginner software engineering, 처음 배우는데 aggregate persistence mapping pitfalls, aggregate persistence mapping pitfalls 입문, aggregate persistence mapping pitfalls 기초, what is aggregate persistence mapping pitfalls, how to aggregate persistence mapping pitfalls
<details>
...
> - [Design Pattern: Aggregate Boundary vs Transaction Boundary](../design-pattern/aggregate-boundary-vs-transaction-boundary.md)
...
> - [System Design: Projection Applied Watermark Basics](../system-design/projection-applied-watermark-basics.md)
>
