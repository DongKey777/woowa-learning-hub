...
- connection timeout vs statement timeout vs lock wait timeout
...
- [락 기초](./lock-basics.md)
- [DB timeout 첫 분기 카드](./db-timeout-first-splitter.md)
...
- timeout 이름이 여러 개 섞여서 deadlock 전에 1차 분기부터 하고 싶다면 [DB timeout 첫 분기 카드](./db-timeout-first-splitter.md)
