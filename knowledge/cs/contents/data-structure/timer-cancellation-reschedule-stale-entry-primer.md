...
- Java `ScheduledFuture.cancel()`과 `removeOnCancelPolicy`의 queue retention trade-off가 궁금하면 [ScheduledFuture Cancellation Stale Entries](./scheduledfuture-cancel-stale-entries.md)
