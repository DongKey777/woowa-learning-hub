...
retrieval-anchor-keywords: top k heap direction patterns basics, top k heap direction patterns beginner, top k heap direction patterns intro, data structure basics, beginner data structure, 처음 배우는데 top k heap direction patterns, top k heap direction patterns 입문, top k heap direction patterns 기초, what is top k heap direction patterns, how to top k heap direction patterns
> 관련 문서:
> - [힙 기초](./heap-basics.md)
