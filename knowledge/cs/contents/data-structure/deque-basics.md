...
retrieval-anchor-keywords: deque basics, double ended queue, 덱 입문, 덱이 뭐예요, deque vs queue vs stack, arraydeque java, addfirst addlast, 양방향 큐 설명, 덱과 스택 차이, 덱과 큐 차이, beginner deque, deque sliding window
