...
retrieval-anchor-keywords: binary tree vs bst vs heap bridge basics, binary tree vs bst vs heap bridge beginner, binary tree vs bst vs heap bridge intro, data structure basics, beginner data structure, 처음 배우는데 binary tree vs bst vs heap bridge, binary tree vs bst vs heap bridge 입문, binary tree vs bst vs heap bridge 기초, what is binary tree vs bst vs heap bridge, how to binary tree vs bst vs heap bridge
> 관련 문서:
> - [기본 자료 구조](./basic.md)
> - [자료구조 정리](./README.md)
