...
retrieval-anchor-keywords: process vs thread, stack vs heap, virtual memory basics, context switch basics, scheduler basics, what is process thread memory, process thread memory basics, address space basics, rss vs vsz, page fault basics, running ready blocked example, 운영체제 처음, 뭐예요 헷갈림, why context switch, when scheduler runs
...
| "context switch가 왜 느리죠?" | CPU 전환 비용 | `## 5. context switch` | [컨텍스트 스위칭, 데드락, lock-free](./context-switching-deadlock-lockfree.md) |
