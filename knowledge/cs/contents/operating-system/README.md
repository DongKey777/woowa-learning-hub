...
| process / scheduler / memory 기초 축 복습 | `primer` | [Process, Thread, Virtual Memory, Context Switch, Scheduler Basics](./process-thread-virtual-memory-context-switch-scheduler-basics.md), [Scheduler Observation Starter Guide](./scheduler-observation-starter-guide.md), [Demand Paging and Page Fault Primer](./demand-paging-page-fault-primer.md), [TLB and Page Table Walk Bridge](./tlb-page-table-walk-bridge.md), [Process Lifecycle and IPC Basics](./process-lifecycle-and-ipc-basics.md), [PID 1, SIGTERM, and Container Reaping Basics](./container-pid-1-sigterm-zombie-reaping-basics.md), [Subprocess FD Hygiene Basics](./subprocess-fd-hygiene-basics.md), [Process Spawn API Comparison: `fork()`, `vfork()`, `posix_spawn()`, `exec()`, `clone()`](./process-spawn-api-comparison.md), [입문 primer](#입문-primer) 아래 기본 섹션 |
...
[Process, Thread, Virtual Memory, Context Switch, Scheduler Basics](./process-thread-virtual-memory-context-switch-scheduler-basics.md) -> [Scheduler Observation Starter Guide](./scheduler-observation-starter-guide.md) -> [Process Lifecycle and IPC Basics](./process-lifecycle-and-ipc-basics.md) -> [Subprocess FD Hygiene Basics](./subprocess-fd-hygiene-basics.md) -> [Process Spawn API Comparison: `fork()`, `vfork()`, `posix_spawn()`, `exec()`, `clone()`](./process-spawn-api-comparison.md) -> [프로세스와 스레드](#프로세스와-스레드) -> [멀티 프로세스와 멀티 스레드](#멀티-프로세스와-멀티-스레드) -> [프로세스 스케줄링](#프로세스-스케줄링) -> [Linux Process State Machine, Zombie, Orphan](./linux-process-state-zombie-orphan.md) -> [Fork, Exec, Copy-on-Write Behavior](./fork-exec-copy-on-write-behavior.md) -> [signals, process supervision](./signals-process-supervision.md) -> [PID 1, SIGTERM, and Container Reaping Basics](./container-pid-1-sigterm-zombie-reaping-basics.md) -> [CPU 스케줄링](#CPU-스케줄링) -> [컨텍스트 스위칭, 데드락, lock-free](./context-switching-deadlock-lockfree.md) -> [Scheduler Wakeup Latency, runqlat, Queueing Debugging](./scheduler-wakeup-latency-runqlat-debugging.md) -> [Run Queue, Load Average, CPU Saturation](./run-queue-load-average-cpu-saturation.md) -> [Load Average Triage: CPU Saturation vs cgroup Throttling vs I/O Wait](./load-average-triage-cpu-saturation-cgroup-throttling-io-wait.md) -> [Scheduler Signals Example Walkthrough: `vmstat`, load average, `/proc/<pid>/sched`, `runqlat`](./scheduler-signals-example-walkthrough.md) -> [schedstat, /proc/<pid>/sched, Runtime Debugging](./schedstat-proc-sched-runtime-debugging.md)
