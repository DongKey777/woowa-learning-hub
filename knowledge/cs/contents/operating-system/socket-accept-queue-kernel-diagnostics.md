...
> retrieval-anchor-keywords: accept queue, sk_ack_backlog, sk_max_ack_backlog, ListenOverflows, ListenDrops, tcp_abort_on_overflow, SYN backlog, ss -ltn, /proc/net/netstat
...
이 문서는 [TCP Backlog, somaxconn, Listen Queue](./tcp-backlog-somaxconn-listen-queue.md)를 커널 관측 지표 중심으로 더 좁힌다.
