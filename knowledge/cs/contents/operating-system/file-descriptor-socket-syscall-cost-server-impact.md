...
> retrieval-anchor-keywords: file descriptor, socket, syscall cost, open file description, socket buffer, epoll, pipe, socketpair, eventfd, memfd, fdinfo, unix domain socket, backend server impact
...
- 제어용 wakeup, byte stream, large payload handoff는 같은 fd여도 다른 primitive가 더 맞을 수 있다
