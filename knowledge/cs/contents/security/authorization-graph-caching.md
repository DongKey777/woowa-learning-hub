...
retrieval-anchor-keywords: authorization graph cache, graph cache, relationship-based access control, path cache, edge cache, authz graph, invalidation, policy version, tenant graph, shortest path authz
