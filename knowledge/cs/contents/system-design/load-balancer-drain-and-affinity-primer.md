...
retrieval-anchor-keywords: load balancer drain and affinity primer, load balancer health check, readiness vs liveness, active health check, passive health check, connection draining, deregistration delay, sticky session, session affinity, cookie affinity, ip hash routing, keepalive drain, http2 goaway, websocket drain, rolling deploy drain, load balancer failover basics, sticky deploy tail, affinity rebalance basics, beginner system design
