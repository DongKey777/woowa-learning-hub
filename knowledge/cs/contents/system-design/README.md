...
| 79 | Shard Key Selection Basics | 🟢 Basic | [shard-key-selection-basics.md](shard-key-selection-basics.md) |
| 80 | Session Revocation Basics | 🟢 Basic | [session-revocation-basics.md](session-revocation-basics.md) |
| 81 | Read-Only and Graceful Degradation Patterns | 🟡 Intermediate | [read-only-and-graceful-degradation-patterns.md](read-only-and-graceful-degradation-patterns.md) |
| 82 | Retry Amplification and Backpressure Primer | 🟢 Basic | [retry-amplification-and-backpressure-primer.md](retry-amplification-and-backpressure-primer.md) |
| 83 | Mixed Cache+Replica Read Path Pitfalls | 🟡 Intermediate | [mixed-cache-replica-read-path-pitfalls.md](mixed-cache-replica-read-path-pitfalls.md) |
