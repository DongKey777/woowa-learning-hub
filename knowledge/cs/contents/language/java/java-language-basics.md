...
retrieval-anchor-keywords: Java language basics, Java platform and JVM, Java primitive types, Java reference type, Java syntax basics, Java control flow, Java array basics, Java variable scope, Java class structure, Java history and characteristics, Java beginner primer, Java class object basics
...
| :-------: | :---------: | :-----------: | :-------------------------------: | :---------------------: |
|  논릿값   |   boolean   |  JVM 구현에 따라 다름 (보통 1byte 이상)  |            true/false             |          false          |
