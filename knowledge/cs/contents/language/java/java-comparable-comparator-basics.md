...
> 한 줄 요약: Java 입문자가 natural ordering, `Comparable`, `Comparator`, 정렬 API, 그리고 `equals()`와의 일관성까지 한 흐름으로 이해하도록 정리한 beginner companion doc이다.
...
> retrieval-anchor-keywords: java comparable basics, java comparator basics, natural ordering, custom comparator, java compareTo basics, java compare method basics, java sorting beginner, java list sort comparator, java stream sorted comparator, java list sort vs stream sorted, java list sort vs collections sort, java collections sort comparable, java collections sort natural order, java Arrays.sort basics, java Arrays.binarySearch basics, java sort search same comparator, java treeset comparator equals consistency, java treemap comparator equals consistency, java compareTo equals consistency, java compareTo returning 0, java comparator consistency checklist, comparator check card, comparator compare 0 equals mismatch, comparator equals inconsistency beginner, java comparator comparing, java comparator thenComparing, java comparator reversed, java comparator reversed scope, java whole chain reversed comparator, java single field reversed comparator, java comparator nullsFirst, java comparator nullsLast, java comparator utility patterns, java natural order beginner, java custom order beginner, java sorted collection duplicate surprise, java TreeSet natural ordering duplicate, java TreeMap natural ordering replace value, compareTo TreeSet TreeMap bridge, treemap mutable key, treemap key mutation lookup, mutable key compareTo bug, navigableset floor ceiling lower higher, navigablemap floorKey ceilingKey lowerKey higherKey, comparator order drives lookup behavior, mutable comparator field sorted collection, java BigDecimal compareTo equals, 자바 comparable comparator 차이, 처음 배우는데 comparable comparator, compareTo comparator 언제 쓰는지, comparator 일관성 체크, comparator 체크 카드, compare 0 equals 불일치, TreeSet compare 0 equals false, 자바 정렬 기준 큰 그림, 자바 정렬 기준 만들기 기초, 자바 list sort collections sort 차이, treeset compareTo 0 중복 이유, comparator reversed 범위 기초, nullsFirst nullsLast 기초
