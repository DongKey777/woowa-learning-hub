...
retrieval-anchor-keywords: java optional basics, optional 입문, nullpointerexception 방지, optional orelse beginner, optional why use, null 대신 optional, 자바 옵셔널 입문, optional empty ofnullable, 처음 optional, optional 큰 그림, optional 언제 쓰는지, optional vs empty list, optional vs enum, map get null optional 헷갈림
