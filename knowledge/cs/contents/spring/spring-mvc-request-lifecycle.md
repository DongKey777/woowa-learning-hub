...
retrieval-anchor-keywords: DispatcherServlet, HandlerMapping, HandlerAdapter, HandlerMethodArgumentResolver, HandlerMethodReturnValueHandler, HandlerExceptionResolver, HttpMessageConverter, mvc request lifecycle, async dispatch, interceptor, filter
