...
| AI | 시작 파일 | 권장 모델 (mid-tier) | 플래그십 (쿼터 2~3× 소진) |
|---|---|---|---|
| Claude Code | [`CLAUDE.md`](CLAUDE.md) | Sonnet 4.6 | Opus 4.6 |
| Codex (OpenAI) | [`AGENTS.md`](AGENTS.md) | GPT-5.3-Codex | GPT-5.4 |
| Gemini | [`GEMINI.md`](GEMINI.md) | Gemini 2.5 Pro | Gemini 3.1 Pro |

`coach-run.json`이 PR 근거 + peer ranking + 학습 포인트를 미리 정리해 AI에 전달하니, AI는
근거 해석과 한국어 설명에만 집중하면 된다 → mid-tier 모델로 충분. AI가 첫 응답에서 현재
모델을 확인하고, 플래그십이면 mid-tier 재시작을 안내한다.
