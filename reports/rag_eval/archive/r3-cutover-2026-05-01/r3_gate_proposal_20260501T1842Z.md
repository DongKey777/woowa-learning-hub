# R3 Gate Proposal - 2026-05-01T18:42Z
...
R3 quality gates now pass on the expanded 100q pilot. Do not cut over by default yet. The remaining cutover blockers are local full-mode runtime architecture and strict remote artifact import verification. The 2026-05-01T18:42Z smoke proves the actual `bin/rag-ask` R3 full path now uses the hybrid reranker, but one-shot cold CLI latency is still too high for default interactive cutover.
